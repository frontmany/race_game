...
namespace race_game.Screens {
    public class PauseMenuScreen : Panel {
        ...
        public PauseMenuScreen(Action resumeCallback, Action returnToMenuCallback, int mainFormWidth, int mainFormHeight) {
            m_buttons_count = 3;
            m_selected_index = 0;
        ...
        public void SetupPanelUI() {
            ...
            var centerPanel = new Panel {
                ...
                Location = new Point((m_main_form_width - 400) / 2, (m_main_form_height - 500) / 2),
